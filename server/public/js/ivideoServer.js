...
function showEditServerDlg(value) {
	var serverInfo = {
		serverName: value.parent().attr('servername-value'),
		address: value.attr('address-value'),
		type: value.attr('servertype-value')
	}
