$(document).ready(function(){
	...
	$('#themes a').click(function(e){
		...
		switch_theme(current_theme);
		switch_iFrame_theme(current_theme)
		$('#themes i').removeClass('icon-ok');
		$(this).find('i').addClass('icon-ok');
	});
	
	function switch_RecursiveChildIFrame_theme(theme_name, cWindow)  {
		$.each(cWindow.frames, function(key, val) {
		    switch_childIFrame_theme(theme_name, val)
		});
	}	

	function switch_childIFrame_theme(theme_name, cWindow)  {			
		$(cWindow.document).find("#bs-css").attr('href','css/bootstrap-'+theme_name+'.css');
		switch_RecursiveChildIFrame_theme(theme_name, cWindow)
	}

	function switch_iFrame_theme(theme_name)
	{
		switch_RecursiveChildIFrame_theme(theme_name, window)
	}	
